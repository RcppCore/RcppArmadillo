...
arma_inline
typename enable_if2< is_cx<typename T1::elem_type>::no, const mtOp<std::complex<typename T1::elem_type>, T1, op_sqrtmat> >::result
...
template<typename T1>
arma_inline
typename enable_if2< is_cx<typename T1::elem_type>::yes, const Op<T1, op_sqrtmat_cx> >::result
sqrtmat(const Base<typename T1::elem_type,T1>& X)
  {
  arma_extra_debug_sigprint();
...
template<typename T1>
inline
typename enable_if2< is_cx<typename T1::elem_type>::no, bool >::result
...
template<typename T1>
inline
typename enable_if2< is_cx<typename T1::elem_type>::yes, bool >::result

...
inline
void
arma_rng_r::set_seed(const arma_rng_r::seed_type val)
  {
...
inline
void
arma_rng_r::randn_dual_val(eT& out1, eT& out2)
  {
...
inline
void
arma_rng_r::randi_fill(eT* mem, const uword N, const int a, const int b)
  {
  if( (a == 0) && (b == RAND_MAX) )
    {
    for(uword i=0; i<N; ++i)

...
template<typename eT> \
arma_inline \
const mtOp<typename std::complex<typename armaObj<eT>::pod_type>, armaObj<eT>, op_cx_scalar_div_post> \
operator/ \
  ( \
  const armaObj<eT>&                                  X, \
  ...
  arma_extra_debug_sigprint(); \
  \
  return mtOp<typename std::complex<typename armaObj<eT>::pod_type>, armaObj<eT>, op_cx_scalar_div_post>('j', X, k); \
  }
...
template<typename eT> \
arma_inline \
const mtOp<typename std::complex<typename armaObj<eT>::pod_type>, armaObj<eT>, op_cx_scalar_div_pre> \
operator/ \
  ( \
  const std::complex<typename armaObj<eT>::pod_type>& k, \
  const armaObj<eT>&                                  X \
  ...
  arma_extra_debug_sigprint(); \
  \
  return mtOp<typename std::complex<typename armaObj<eT>::pod_type>, armaObj<eT>, op_cx_scalar_div_pre>('j', X, k); \
  }
...
operator/ \
  ...
  arma_extra_debug_sigprint(); \
  \
  return eGlue<BT, armaObj<typename BT::elem_type>, eglue_div>(X.get_ref(), Y); \
  }
...
inline \
const mtGlue<typename promote_type<eT1, eT2>::result, armaObjA<eT1>, armaObjB<eT2>, glue_mixed_div> \
operator/ \
  ( \

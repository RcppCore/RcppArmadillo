...
inline
const Op<T1, op_cor>
cor(const Base<typename T1::elem_type,T1>& X, const u32 norm_type = 0)
  {
...
cor(const Base<typename T1::elem_type,T1>& A, const Base<typename T1::elem_type,T2>& B, const u32 norm_type = 0)
  {
  arma_extra_debug_sigprint();
